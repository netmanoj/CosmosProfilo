  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        >
          <h2 className="text-xl font-semibold mb-3 text-white">Publications</h2>
          <ul className="space-y-4 text-white/80">
            <li>
              <strong>Homieforever Food Delivery Driven Company from Homemade Kitchen</strong>
              <p>Published in International Research Journal of Engineering and Technology (IRJET), Volume: 08, Issue: 07 (July 2021)</p>
            </li>
            <li>
              <p>
                +2 additional international journal publications –{' '}
                <a 
                  href="https://www.linkedin.com/in/livingmanoj/details/publications/" 
                  target="_blank" 
                  rel="noopener noreferrer"
